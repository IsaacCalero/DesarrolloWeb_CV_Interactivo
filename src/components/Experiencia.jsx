...
const Experiencia = ({ experiencias, onAdd, onUpdate, onDelete, isEditingMode, darkMode }) => {
  ...
  const inputClasses = `w-full p-3 rounded-lg border focus:ring-2 focus:ring-orange-500 transition-all outline-none ${
  ...
  const itemClasses = `p-4 rounded-lg border-l-4 transition-all duration-300 ${
    darkMode ? 'bg-gray-700 border-orange-500' : 'bg-gray-50 border-orange-500'
  }`;
